...
type profileRespositoryPostgres struct {
	db *sql.DB
}

func NewProfileRespositoryPostgres(db *sql.DB) *profileRespositoryPostgres {
	return &profileRespositoryPostgres{db}
}

func (r *profileRespositoryPostgres) Save(profile *model.Profile) error {
...
func (r *profileRespositoryPostgres) Update(id string, profile *model.Profile) error {
...
func (r *profileRespositoryPostgres) Delete(id string) error {
...
func (r *profileRespositoryPostgres) FindByID(id string) (*model.Profile, error) {
...
func (r *profileRespositoryPostgres) FindAll() (model.Profiles, error) {
